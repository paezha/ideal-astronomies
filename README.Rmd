...
fig01 <-  ggplot() +
  labs(caption = "Source: https://mastodon.online/@hourlycosmos@deepspace.social/109860384723025685") +
  theme_void() +
  theme(plot.caption = element_text(size = 15))

# Draw image and empty ggplot object
ggdraw() +
  draw_image("inputs/109860384723025685.jpg",
             y = 0.05) +
  draw_plot(fig01)
```

```{r fig02, echo=FALSE, out.width="300px"}
# Create empty ggplot object with caption
fig02 <-  ggplot() +
  labs(caption = "Source: https://deepspace.social/@hourlycosmos/109854013279669354") +
  theme_void() +
  theme(plot.caption = element_text(size = 15))

# Draw image and empty ggplot object
ggdraw() +
  draw_image("inputs/109854013279669354.jpeg",
             y = 0.05) +
  draw_plot(fig02)
```

```{r fig03, echo=FALSE, out.width="300px"}
# Create empty ggplot object with caption
fig03 <-  ggplot() +
  labs(caption = "Source: https://deepspace.social/@hourlycosmos/109810366440473863") +
  theme_void() +
  theme(plot.caption = element_text(size = 15))

# Draw image and empty ggplot object
ggdraw() +
  draw_image("inputs/109810366440473863.jpeg",
             y = 0.05) +
  draw_plot(fig03)
```

```{r fig04, echo=FALSE, out.width="300px"}
# Create empty ggplot object with caption
fig04 <-  ggplot() +
  labs(caption = "Source: https://deepspace.social/@hourlycosmos/109800457272267375") +
  theme_void() +
  theme(plot.caption = element_text(size = 15))

# Draw image and empty ggplot object
ggdraw() +
  draw_image("inputs/109800457272267375.jpeg",
             y = 0.05) +
  draw_plot(fig04)
```
